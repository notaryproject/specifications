...
For each CDP location, Implementations of the Notary Project specification will try to download the CRL for the default threshold of 10 seconds.
...
Implementations of the Notary Project specification will wait for a default threshold of 5 seconds to receive an OCSP response.
