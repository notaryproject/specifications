...
2. Construct the `Sig_structure` for `COSE_Sign1`. The context string Signature1 is used to identify the context of signatures using the COSE_Sign1 structure.
    ```yaml
    Sig_structure = [
        / context / 'Signature1',
