...
* `notary.x509.signingAuthority` MUST use a date/time (UTC) attribute that is generated by the signing service as part of the original signature to determine `authentic signing time`.
