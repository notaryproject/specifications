...
* `notary.x509` can ONLY use a countersignature (timestamp) to prove that the signature was created on or before the time point been stamped by the `Timestamp Authority (TSA)`.
