...
This is supported through the the Timestamp signature unsigned attribute in the signature envelope. Currently the Notary Project uses a [RFC3161](ietf-rfc3161) compliant TSA signature for this purpose.
