...
1. In the absense of an Authentic Timestamp, each and every certificate in the signature i.e. signing certificate, intermediate certificates, and the root certificate must be valid i.e. not expired at the time of signature verification.
