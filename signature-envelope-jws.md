...
Example with Signing Scheme `notary.default.x509`

```jsonc
{
    "alg": "PS384",
    "cty": "application/vnd.cncf.notary.payload.v1+json",
    "io.cncf.notary.signingScheme": "notary.default.x509",
...
Example with Signing Scheme `notary.signingAuthority.x509`

```jsonc
{
    "alg": "PS384",
    "cty": "application/vnd.cncf.notary.payload.v1+json",
    "io.cncf.notary.signingScheme": "notary.signingAuthority.x509",
